    ...
    return (
        <>
            <motion.section
                ...
                className={
                    "h-screen max-h-[800px] min-h-[500px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]"
                }
                style={{
            ...
            >
                ...
                <div className={"container relative mt-16"}>
                    <h1
                        className={
                            "text-7xl md:text-[120px] md:leading-none font-semibold bg-white tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,0.5))] bg-clip-text text-transparent text-center"
                        }
                    >
                        Mr. Happy
                    </h1>
                    ...
                    >
                        Elevate your productivity with AI-powered assistance. Where smart 
                        technology meets user-friendly tools for your everyday needs.
                    </p>
