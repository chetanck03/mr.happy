...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate signup - replace with actual signup functionality
    setTimeout(() => {
      setIsLoading(false);
    ...
    <div className="flex min-h-screen bg-black">
      <div className="flex-1 relative flex items-center justify-center">
        ...
        >
          ...
          <p className="text-white/70 mb-8">Join Mr. Happy and boost your productivity today</p>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="mt-1 text-sm text-white/50">Must be at least 8 characters</p>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-800">
            <div className="flex items-center justify-center mb-4">
              <span className="text-sm text-white/50">Or sign up with</span>
            </div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-br from-purple-900 to-indigo-900">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-xl text-white">
            <h2 className="text-4xl font-bold mb-6">Supercharge your workflow with Mr. Happy</h2>
            <p className="text-xl mb-8">Our AI assistant helps you organize tasks, brainstorm ideas, and stay motivated throughout your day.</p>
            <div className="bg-black/30 p-6 rounded-xl backdrop-blur-sm border border-white/10">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <p className="font-medium">Mr. Happy</p>
